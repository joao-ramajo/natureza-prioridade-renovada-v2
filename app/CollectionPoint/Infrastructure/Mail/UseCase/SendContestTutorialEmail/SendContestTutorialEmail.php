...
namespace App\CollectionPoint\Infrastructure\Mail\UseCase\SendContestTutorialEmail;

use App\CollectionPoint\Infrastructure\Mail\ContestedPointMail;
use App\CollectionPoint\Infrastructure\Mail\PointApprovedMail;
use App\CollectionPoint\Domain\CollectionPoint;
use Illuminate\Support\Facades\Mail;
use Exception;

class SendContestTutorialEmail
{
